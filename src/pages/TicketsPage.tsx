...
const PRICE_IDS: Record<ShowOption, string> = {
  semifinal: "ticket_semifinal_presale",
  finale: "ticket_finale_presale",
  bundle: "ticket_bundle_presale",
};
    ...
    <Layout>
      ...
      <section className="py-20 bg-black-deep min-h-screen">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          {checkoutOpen && selectedShow ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
              <button
                onClick={() => setCheckoutOpen(false)}
                className="text-cream/70 hover:text-gold-royal text-sm underline"
              >
                ← {lang === "fr" ? "Retour à la sélection" : "Back to selection"}
              </button>
